import 'dart:async';
import 'dart:io';
import 'package:kmmrcepay_package/model/Transaction.dart';
import 'package:kmmrcepay_package/model/UserRequest.dart';
...
class kmmrcepay extends StatefulWidget {
  final UserRequest user;
  final Closure closure;

  kmmrcepay({Key key, @required this.user, this.closure}) : super(key: key);
  @override
  _kmmrcepayState createState() => new _kmmrcepayState();
}

class _kmmrcepayState extends State<kmmrcepay> {
  ...
  String loadData() {
    ...
    String productionURL = "https://payments.kmmrcepay.co.in/pay/index.php";
    String productionFailedURL = "https://payments.kmmrcepay.co.in/error.php";
    // String productionVPAURL = "https://payments.kmmrcepay.co.in/upi/v.php";
    String stagingURL = "https://payments.kmmrcepay.ninja/pay/index.php";
    String stagingFailedURL = "https://payments.kmmrcepay.ninja/error.php";
    // String stagingVPAURL = "https://payments.kmmrcepay.ninja/upi/v.php";
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      String errMsg = '';
      if (widget.user == null) {
        errMsg = 'Kindly enter your kmmrcepay details to proceed';
      }
      if (widget.user.protoDomain == null || widget.user.protoDomain.isEmpty) {
        errMsg = 'Kindly enter your kmmrcepay protoDomain to proceed';
      } else if (widget.user.merchantId == null ||
          widget.user.merchantId.isEmpty) {
        errMsg = 'Kindly enter your kmmrcepay MerchantID to proceed';
      } else if (widget.user.secret == null || widget.user.secret.isEmpty) {
        errMsg = 'Kindly enter your kmmrcepay secretID to proceed';
      } else if (widget.user.successUrl == null ||
          widget.user.successUrl.isEmpty) {
        errMsg = 'Kindly enter your kmmrcepay SuccessURL to proceed';
      }
      // else if (widget.user.failedUrl == null ||
      //     widget.user.failedUrl.isEmpty) {
      //   errMsg = 'Kindly enter your kmmrcepay failedUrl to proceed';
      // }
  ...
  fetchDetails() async {
    ...
    String stagingDataURL = "https://payments.kmmrcepay.ninja/sdk/a.php";
    String productionDataURL = "https://payments.kmmrcepay.co.in/sdk/a.php";
    var isGateWay = (user.isStaging != null && user.isStaging == true)
        ? stagingDataURL
        : productionDataURL;
